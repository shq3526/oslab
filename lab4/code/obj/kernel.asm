...
ffffffffc0200060:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc0200062:	5d7030ef          	jal	ra,ffffffffc0203e38 <memset>
    dtb_init();
...
ffffffffc0200072:	e1a58593          	addi	a1,a1,-486 # ffffffffc0203e88 <etext+0x2>
ffffffffc0200076:	00004517          	auipc	a0,0x4
ffffffffc020007a:	e3250513          	addi	a0,a0,-462 # ffffffffc0203ea8 <etext+0x22>
...
ffffffffc0200096:	562030ef          	jal	ra,ffffffffc02035f8 <proc_init>
...
ffffffffc02000a2:	7a4030ef          	jal	ra,ffffffffc0203846 <cpu_idle>
...
ffffffffc02000c0:	df450513          	addi	a0,a0,-524 # ffffffffc0203eb0 <etext+0x2a>
...
ffffffffc0200186:	c602                	sw	zero,12(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc0200188:	08d030ef          	jal	ra,ffffffffc0203a14 <vprintfmt>
    return cnt;
}
...
ffffffffc02001bc:	c202                	sw	zero,4(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc02001be:	057030ef          	jal	ra,ffffffffc0203a14 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001e2:	cda50513          	addi	a0,a0,-806 # ffffffffc0203eb8 <etext+0x32>
{
...
ffffffffc02001f8:	ce450513          	addi	a0,a0,-796 # ffffffffc0203ed8 <etext+0x52>
ffffffffc02001fc:	f99ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200200:	00004597          	auipc	a1,0x4
ffffffffc0200204:	c8658593          	addi	a1,a1,-890 # ffffffffc0203e86 <etext>
ffffffffc0200208:	00004517          	auipc	a0,0x4
ffffffffc020020c:	cf050513          	addi	a0,a0,-784 # ffffffffc0203ef8 <etext+0x72>
...
ffffffffc0200220:	cfc50513          	addi	a0,a0,-772 # ffffffffc0203f18 <etext+0x92>
...
ffffffffc0200234:	d0850513          	addi	a0,a0,-760 # ffffffffc0203f38 <etext+0xb2>
...
ffffffffc0200262:	cfa50513          	addi	a0,a0,-774 # ffffffffc0203f58 <etext+0xd2>
}
...
ffffffffc0200270:	d1c60613          	addi	a2,a2,-740 # ffffffffc0203f88 <etext+0x102>
ffffffffc0200274:	04900593          	li	a1,73
ffffffffc0200278:	00004517          	auipc	a0,0x4
ffffffffc020027c:	d2850513          	addi	a0,a0,-728 # ffffffffc0203fa0 <etext+0x11a>
{
...
ffffffffc020028c:	d3060613          	addi	a2,a2,-720 # ffffffffc0203fb8 <etext+0x132>
ffffffffc0200290:	00004597          	auipc	a1,0x4
ffffffffc0200294:	d4858593          	addi	a1,a1,-696 # ffffffffc0203fd8 <etext+0x152>
ffffffffc0200298:	00004517          	auipc	a0,0x4
ffffffffc020029c:	d4850513          	addi	a0,a0,-696 # ffffffffc0203fe0 <etext+0x15a>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002aa:	d4a60613          	addi	a2,a2,-694 # ffffffffc0203ff0 <etext+0x16a>
ffffffffc02002ae:	00004597          	auipc	a1,0x4
ffffffffc02002b2:	d6a58593          	addi	a1,a1,-662 # ffffffffc0204018 <etext+0x192>
ffffffffc02002b6:	00004517          	auipc	a0,0x4
ffffffffc02002ba:	d2a50513          	addi	a0,a0,-726 # ffffffffc0203fe0 <etext+0x15a>
ffffffffc02002be:	ed7ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
ffffffffc02002c2:	00004617          	auipc	a2,0x4
ffffffffc02002c6:	d6660613          	addi	a2,a2,-666 # ffffffffc0204028 <etext+0x1a2>
ffffffffc02002ca:	00004597          	auipc	a1,0x4
ffffffffc02002ce:	d7e58593          	addi	a1,a1,-642 # ffffffffc0204048 <etext+0x1c2>
ffffffffc02002d2:	00004517          	auipc	a0,0x4
ffffffffc02002d6:	d0e50513          	addi	a0,a0,-754 # ffffffffc0203fe0 <etext+0x15a>
...
ffffffffc0200310:	d4c50513          	addi	a0,a0,-692 # ffffffffc0204058 <etext+0x1d2>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200332:	d5250513          	addi	a0,a0,-686 # ffffffffc0204080 <etext+0x1fa>
...
ffffffffc020035c:	d5090913          	addi	s2,s2,-688 # ffffffffc02040a8 <etext+0x222>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200360:	00004497          	auipc	s1,0x4
ffffffffc0200364:	d5048493          	addi	s1,s1,-688 # ffffffffc02040b0 <etext+0x22a>
        if (argc == MAXARGS - 1) {
ffffffffc0200368:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020036a:	00004b17          	auipc	s6,0x4
ffffffffc020036e:	d4eb0b13          	addi	s6,s6,-690 # ffffffffc02040b8 <etext+0x232>
        argv[argc ++] = buf;
ffffffffc0200372:	00004a17          	auipc	s4,0x4
ffffffffc0200376:	c66a0a13          	addi	s4,s4,-922 # ffffffffc0203fd8 <etext+0x152>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	23d030ef          	jal	ra,ffffffffc0203dde <strcmp>
...
ffffffffc02003b4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003b6:	229030ef          	jal	ra,ffffffffc0203dde <strcmp>
...
ffffffffc02003f4:	22f030ef          	jal	ra,ffffffffc0203e22 <strchr>
...
ffffffffc0200432:	1f1030ef          	jal	ra,ffffffffc0203e22 <strchr>
...
ffffffffc0200450:	c8c50513          	addi	a0,a0,-884 # ffffffffc02040d8 <etext+0x252>
...
ffffffffc0200746:	650030ef          	jal	ra,ffffffffc0203d96 <strlen>
...
ffffffffc0200752:	2a01                	sext.w	s4,s4
                if (strncmp(name, "memory", 6) == 0) {
ffffffffc0200754:	6a8030ef          	jal	ra,ffffffffc0203dfc <strncmp>
...
ffffffffc02007ea:	5f4030ef          	jal	ra,ffffffffc0203dde <strcmp>
...
ffffffffc0200c1c:	87870713          	addi	a4,a4,-1928 # ffffffffc020d490 <print_num>
...
ffffffffc0201de0:	058020ef          	jal	ra,ffffffffc0203e38 <memset>
    return page - pages + nbase;
...
ffffffffc0201e82:	7b7010ef          	jal	ra,ffffffffc0203e38 <memset>
    return page - pages + nbase;
...
ffffffffc0201f14:	13f00593          	li	a1,319
...
ffffffffc0201f2c:	12c00593          	li	a1,300
...
ffffffffc0201f46:	12100593          	li	a1,289
...
ffffffffc0201f60:	13800593          	li	a1,312
...
ffffffffc02025fa:	7d2010ef          	jal	ra,ffffffffc0203dcc <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02025fe:	10040593          	addi	a1,s0,256
ffffffffc0202602:	10000513          	li	a0,256
ffffffffc0202606:	7d8010ef          	jal	ra,ffffffffc0203dde <strcmp>
...
ffffffffc0202638:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc020263c:	75a010ef          	jal	ra,ffffffffc0203d96 <strlen>
...
ffffffffc020286c:	1ed00593          	li	a1,493
...
ffffffffc020288c:	1ee00593          	li	a1,494
...
ffffffffc02028ac:	1ed00593          	li	a1,493
...
ffffffffc02028d4:	1bc00593          	li	a1,444
...
ffffffffc02028f4:	1ad00593          	li	a1,429
...
ffffffffc0202914:	1ac00593          	li	a1,428
...
ffffffffc0202934:	1aa00593          	li	a1,426
...
ffffffffc020294c:	0a100593          	li	a1,161
...
ffffffffc020296c:	1d600593          	li	a1,470
...
ffffffffc020298c:	1d400593          	li	a1,468
...
ffffffffc02029ac:	1d300593          	li	a1,467
...
ffffffffc02029cc:	1f100593          	li	a1,497
...
ffffffffc02029ec:	1de00593          	li	a1,478
...
ffffffffc0202a0c:	1f600593          	li	a1,502
...
ffffffffc0202a2c:	1f500593          	li	a1,501
...
ffffffffc0202a4c:	1d000593          	li	a1,464
...
ffffffffc0202a6c:	1cf00593          	li	a1,463
...
ffffffffc0202a8c:	1cc00593          	li	a1,460
...
ffffffffc0202aac:	1cb00593          	li	a1,459
...
ffffffffc0202acc:	1ca00593          	li	a1,458
...
ffffffffc0202aec:	1c900593          	li	a1,457
...
ffffffffc0202b0c:	1c800593          	li	a1,456
...
ffffffffc0202b2c:	1c700593          	li	a1,455
...
ffffffffc0202b4c:	1c500593          	li	a1,453
...
ffffffffc0202b6c:	1c400593          	li	a1,452
...
ffffffffc0202b8c:	1c300593          	li	a1,451
...
ffffffffc0202bac:	1c200593          	li	a1,450
...
ffffffffc0202bc4:	07b00593          	li	a1,123
...
ffffffffc0202be4:	20800593          	li	a1,520
...
ffffffffc0202c04:	1c100593          	li	a1,449
...
ffffffffc0202c24:	1c000593          	li	a1,448
...
ffffffffc0202c3e:	1bb00593          	li	a1,443
...
ffffffffc0202c56:	1ba00593          	li	a1,442
...
ffffffffc0202c76:	1b800593          	li	a1,440
...
ffffffffc0202c96:	1b700593          	li	a1,439
...
ffffffffc0202cb6:	1ff00593          	li	a1,511
...
ffffffffc0202cd6:	1fc00593          	li	a1,508
...
ffffffffc0202cf6:	1f800593          	li	a1,504
...
ffffffffc0202d16:	1f700593          	li	a1,503
...
ffffffffc0202d2e:	0ed00593          	li	a1,237
...
ffffffffc0202d46:	0a000593          	li	a1,160
...
ffffffffc0202d66:	1b600593          	li	a1,438
...
ffffffffc0202d86:	1b300593          	li	a1,435
...
ffffffffc0202da8:	0ad00593          	li	a1,173
...
ffffffffc0202e7a:	0b400593          	li	a1,180
...
ffffffffc0202e9a:	0ac00593          	li	a1,172
...
ffffffffc0202eba:	0a900593          	li	a1,169
...
ffffffffc0202f34:	10a00593          	li	a1,266
...
ffffffffc0202f82:	11200593          	li	a1,274
...
ffffffffc0203062:	13f00593          	li	a1,319
...
ffffffffc02030d0:	11e00593          	li	a1,286
...
ffffffffc02030f0:	13300593          	li	a1,307
...
ffffffffc0203110:	13400593          	li	a1,308
...
ffffffffc0203130:	11c00593          	li	a1,284
...
ffffffffc0203150:	12900593          	li	a1,297
...
ffffffffc0203170:	12700593          	li	a1,295
...
ffffffffc0203190:	12d00593          	li	a1,301
...
ffffffffc02031b0:	13100593          	li	a1,305
...
ffffffffc02031d0:	12f00593          	li	a1,303
...
ffffffffc02031f0:	10100593          	li	a1,257
...
ffffffffc0203202:	9402                	jalr	s0
     ...
     */
ffffffffc0203204:	3d8000ef          	jal	ra,ffffffffc02035dc <do_exit>
...
ffffffffc020323e:	3fb000ef          	jal	ra,ffffffffc0203e38 <memset>
...
ffffffffc020325c:	3dd000ef          	jal	ra,ffffffffc0203e38 <memset>
    }
    return proc;
}
...
ffffffffc020329c:	00492983          	lw	s3,4(s2)
    memset(name, 0, sizeof(name));
ffffffffc02032a0:	399000ef          	jal	ra,ffffffffc0203e38 <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02032a4:	0b490593          	addi	a1,s2,180
ffffffffc02032a8:	463d                	li	a2,15
ffffffffc02032aa:	8526                	mv	a0,s1
ffffffffc02032ac:	39f000ef          	jal	ra,ffffffffc0203e4a <memcpy>
...
ffffffffc020332a:	538000ef          	jal	ra,ffffffffc0203862 <switch_to>
    if (flag) {
...
ffffffffc0203370:	1cf75b63          	bge	a4,a5,ffffffffc0203546 <do_fork+0x1ee>
...
ffffffffc020337e:	1c050963          	beqz	a0,ffffffffc0203550 <do_fork+0x1f8>
...
ffffffffc0203384:	90dfe0ef          	jal	ra,ffffffffc0201c90 <alloc_pages>
    if (page != NULL)
ffffffffc0203388:	1a050a63          	beqz	a0,ffffffffc020353c <do_fork+0x1e4>
    return page - pages + nbase;
...
ffffffffc020339e:	63653503          	ld	a0,1590(a0) # ffffffffc02059d0 <nbase>
...
ffffffffc02033b2:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02033b4:	1ce7f063          	bgeu	a5,a4,ffffffffc0203574 <do_fork+0x21c>
    assert(current->mm == NULL);
ffffffffc02033b8:	0000a797          	auipc	a5,0xa
ffffffffc02033bc:	1187b783          	ld	a5,280(a5) # ffffffffc020d4d0 <current>
ffffffffc02033c0:	779c                	ld	a5,40(a5)
ffffffffc02033c2:	0000a717          	auipc	a4,0xa
ffffffffc02033c6:	10673703          	ld	a4,262(a4) # ffffffffc020d4c8 <va_pa_offset>
ffffffffc02033ca:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page); // 获取内核虚拟地址
ffffffffc02033cc:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc02033d0:	18079263          	bnez	a5,ffffffffc0203554 <do_fork+0x1fc>
...
ffffffffc02033dc:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02033de:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc02033e2:	87b6                	mv	a5,a3
ffffffffc02033e4:	12040893          	addi	a7,s0,288
ffffffffc02033e8:	00063803          	ld	a6,0(a2)
ffffffffc02033ec:	6608                	ld	a0,8(a2)
ffffffffc02033ee:	6a0c                	ld	a1,16(a2)
ffffffffc02033f0:	6e18                	ld	a4,24(a2)
ffffffffc02033f2:	0107b023          	sd	a6,0(a5)
ffffffffc02033f6:	e788                	sd	a0,8(a5)
ffffffffc02033f8:	eb8c                	sd	a1,16(a5)
ffffffffc02033fa:	ef98                	sd	a4,24(a5)
ffffffffc02033fc:	02060613          	addi	a2,a2,32
ffffffffc0203400:	02078793          	addi	a5,a5,32
ffffffffc0203404:	ff1612e3          	bne	a2,a7,ffffffffc02033e8 <do_fork+0x90>
    proc->tf->gpr.a0 = 0;
ffffffffc0203408:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020340c:	10090c63          	beqz	s2,ffffffffc0203524 <do_fork+0x1cc>
    if (++last_pid >= MAX_PID)
ffffffffc0203410:	00006817          	auipc	a6,0x6
ffffffffc0203414:	c1880813          	addi	a6,a6,-1000 # ffffffffc0209028 <last_pid.1>
ffffffffc0203418:	00082783          	lw	a5,0(a6)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020341c:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0203420:	00000717          	auipc	a4,0x0
ffffffffc0203424:	e4a70713          	addi	a4,a4,-438 # ffffffffc020326a <forkret>
    if (++last_pid >= MAX_PID)
ffffffffc0203428:	0017851b          	addiw	a0,a5,1
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020342c:	02e9b823          	sd	a4,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0203430:	02d9bc23          	sd	a3,56(s3)
    if (++last_pid >= MAX_PID)
ffffffffc0203434:	00a82023          	sw	a0,0(a6)
ffffffffc0203438:	6789                	lui	a5,0x2
ffffffffc020343a:	06f55e63          	bge	a0,a5,ffffffffc02034b6 <do_fork+0x15e>
    if (last_pid >= next_safe)
ffffffffc020343e:	00006317          	auipc	t1,0x6
ffffffffc0203442:	bee30313          	addi	t1,t1,-1042 # ffffffffc020902c <next_safe.0>
ffffffffc0203446:	00032783          	lw	a5,0(t1)
ffffffffc020344a:	0000a417          	auipc	s0,0xa
ffffffffc020344e:	00e40413          	addi	s0,s0,14 # ffffffffc020d458 <proc_list>
ffffffffc0203452:	06f55a63          	bge	a0,a5,ffffffffc02034c6 <do_fork+0x16e>
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0203456:	45a9                	li	a1,10
    proc->pid = get_pid(); // 获取唯一的 PID
ffffffffc0203458:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020345c:	2501                	sext.w	a0,a0
ffffffffc020345e:	534000ef          	jal	ra,ffffffffc0203992 <hash32>
ffffffffc0203462:	02051793          	slli	a5,a0,0x20
ffffffffc0203466:	01c7d513          	srli	a0,a5,0x1c
ffffffffc020346a:	00006797          	auipc	a5,0x6
ffffffffc020346e:	fde78793          	addi	a5,a5,-34 # ffffffffc0209448 <hash_list>
ffffffffc0203472:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0203474:	6518                	ld	a4,8(a0)
ffffffffc0203476:	0d898793          	addi	a5,s3,216
ffffffffc020347a:	6414                	ld	a3,8(s0)
    prev->next = next->prev = elm;
ffffffffc020347c:	e31c                	sd	a5,0(a4)
ffffffffc020347e:	e51c                	sd	a5,8(a0)
    nr_process++;          // 进程总数 +1
ffffffffc0203480:	409c                	lw	a5,0(s1)
    elm->next = next;
ffffffffc0203482:	0ee9b023          	sd	a4,224(s3)
    elm->prev = prev;
ffffffffc0203486:	0ca9bc23          	sd	a0,216(s3)
    list_add(&proc_list, &(proc->list_link)); // 加入全局链表，用于调度和统计
ffffffffc020348a:	0c898713          	addi	a4,s3,200
    prev->next = next->prev = elm;
ffffffffc020348e:	e298                	sd	a4,0(a3)
    nr_process++;          // 进程总数 +1
ffffffffc0203490:	2785                	addiw	a5,a5,1
    wakeup_proc(proc);
ffffffffc0203492:	854e                	mv	a0,s3
    elm->next = next;
ffffffffc0203494:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc0203498:	0c89b423          	sd	s0,200(s3)
    prev->next = next->prev = elm;
ffffffffc020349c:	e418                	sd	a4,8(s0)
    nr_process++;          // 进程总数 +1
ffffffffc020349e:	c09c                	sw	a5,0(s1)
    wakeup_proc(proc);
ffffffffc02034a0:	42c000ef          	jal	ra,ffffffffc02038cc <wakeup_proc>
    ret = proc->pid;
ffffffffc02034a4:	0049a503          	lw	a0,4(s3)
}
ffffffffc02034a8:	70a2                	ld	ra,40(sp)
ffffffffc02034aa:	7402                	ld	s0,32(sp)
ffffffffc02034ac:	64e2                	ld	s1,24(sp)
ffffffffc02034ae:	6942                	ld	s2,16(sp)
ffffffffc02034b0:	69a2                	ld	s3,8(sp)
ffffffffc02034b2:	6145                	addi	sp,sp,48
ffffffffc02034b4:	8082                	ret
        last_pid = 1;
ffffffffc02034b6:	4785                	li	a5,1
ffffffffc02034b8:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02034bc:	4505                	li	a0,1
ffffffffc02034be:	00006317          	auipc	t1,0x6
ffffffffc02034c2:	b6e30313          	addi	t1,t1,-1170 # ffffffffc020902c <next_safe.0>
    return listelm->next;
ffffffffc02034c6:	0000a417          	auipc	s0,0xa
ffffffffc02034ca:	f9240413          	addi	s0,s0,-110 # ffffffffc020d458 <proc_list>
ffffffffc02034ce:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc02034d2:	6789                	lui	a5,0x2
ffffffffc02034d4:	00f32023          	sw	a5,0(t1)
ffffffffc02034d8:	86aa                	mv	a3,a0
ffffffffc02034da:	4581                	li	a1,0
        while ((le = list_next(le)) != list)
ffffffffc02034dc:	6e89                	lui	t4,0x2
ffffffffc02034de:	048e0a63          	beq	t3,s0,ffffffffc0203532 <do_fork+0x1da>
ffffffffc02034e2:	88ae                	mv	a7,a1
ffffffffc02034e4:	87f2                	mv	a5,t3
ffffffffc02034e6:	6609                	lui	a2,0x2
ffffffffc02034e8:	a811                	j	ffffffffc02034fc <do_fork+0x1a4>
            else if (proc->pid > last_pid && next_safe > proc->pid)
ffffffffc02034ea:	00e6d663          	bge	a3,a4,ffffffffc02034f6 <do_fork+0x19e>
ffffffffc02034ee:	00c75463          	bge	a4,a2,ffffffffc02034f6 <do_fork+0x19e>
ffffffffc02034f2:	863a                	mv	a2,a4
ffffffffc02034f4:	4885                	li	a7,1
ffffffffc02034f6:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc02034f8:	00878d63          	beq	a5,s0,ffffffffc0203512 <do_fork+0x1ba>
            if (proc->pid == last_pid)
ffffffffc02034fc:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0203500:	fed715e3          	bne	a4,a3,ffffffffc02034ea <do_fork+0x192>
                if (++last_pid >= next_safe)
ffffffffc0203504:	2685                	addiw	a3,a3,1
ffffffffc0203506:	02c6d163          	bge	a3,a2,ffffffffc0203528 <do_fork+0x1d0>
ffffffffc020350a:	679c                	ld	a5,8(a5)
ffffffffc020350c:	4585                	li	a1,1
        while ((le = list_next(le)) != list)
ffffffffc020350e:	fe8797e3          	bne	a5,s0,ffffffffc02034fc <do_fork+0x1a4>
ffffffffc0203512:	c581                	beqz	a1,ffffffffc020351a <do_fork+0x1c2>
ffffffffc0203514:	00d82023          	sw	a3,0(a6)
ffffffffc0203518:	8536                	mv	a0,a3
ffffffffc020351a:	f2088ee3          	beqz	a7,ffffffffc0203456 <do_fork+0xfe>
ffffffffc020351e:	00c32023          	sw	a2,0(t1)
ffffffffc0203522:	bf15                	j	ffffffffc0203456 <do_fork+0xfe>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0203524:	8936                	mv	s2,a3
ffffffffc0203526:	b5ed                	j	ffffffffc0203410 <do_fork+0xb8>
                    if (last_pid >= MAX_PID)
ffffffffc0203528:	01d6c363          	blt	a3,t4,ffffffffc020352e <do_fork+0x1d6>
                        last_pid = 1;
ffffffffc020352c:	4685                	li	a3,1
                    goto repeat; // 重新开始搜索
ffffffffc020352e:	4585                	li	a1,1
ffffffffc0203530:	b77d                	j	ffffffffc02034de <do_fork+0x186>
ffffffffc0203532:	cd81                	beqz	a1,ffffffffc020354a <do_fork+0x1f2>
ffffffffc0203534:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc0203538:	8536                	mv	a0,a3
ffffffffc020353a:	bf31                	j	ffffffffc0203456 <do_fork+0xfe>
    kfree(proc);
ffffffffc020353c:	854e                	mv	a0,s3
ffffffffc020353e:	e24fe0ef          	jal	ra,ffffffffc0201b62 <kfree>
    ret = -E_NO_MEM;
ffffffffc0203542:	5571                	li	a0,-4
    goto fork_out;
ffffffffc0203544:	b795                	j	ffffffffc02034a8 <do_fork+0x150>
    int ret = -E_NO_FREE_PROC;
ffffffffc0203546:	556d                	li	a0,-5
ffffffffc0203548:	b785                	j	ffffffffc02034a8 <do_fork+0x150>
    return last_pid;
ffffffffc020354a:	00082503          	lw	a0,0(a6)
ffffffffc020354e:	b721                	j	ffffffffc0203456 <do_fork+0xfe>
    ret = -E_NO_MEM;
ffffffffc0203550:	5571                	li	a0,-4
    return ret;
ffffffffc0203552:	bf99                	j	ffffffffc02034a8 <do_fork+0x150>
    assert(current->mm == NULL);
ffffffffc0203554:	00002697          	auipc	a3,0x2
...
ffffffffc0203578:	77c60613          	addi	a2,a2,1916 # ffffffffc0204cf0 <default_pmm_manager+0x38>
ffffffffc020357c:	0a100593          	li	a1,161
ffffffffc0203580:	00001517          	auipc	a0,0x1
ffffffffc0203584:	79850513          	addi	a0,a0,1944 # ffffffffc0204d18 <default_pmm_manager+0x60>
ffffffffc0203588:	ed3fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc020358c <kernel_thread>:
{
ffffffffc020358c:	7129                	addi	sp,sp,-320
ffffffffc020358e:	fa22                	sd	s0,304(sp)
ffffffffc0203590:	f626                	sd	s1,296(sp)
ffffffffc0203592:	f24a                	sd	s2,288(sp)
ffffffffc0203594:	84ae                	mv	s1,a1
ffffffffc0203596:	892a                	mv	s2,a0
ffffffffc0203598:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020359a:	4581                	li	a1,0
ffffffffc020359c:	12000613          	li	a2,288
ffffffffc02035a0:	850a                	mv	a0,sp
{
ffffffffc02035a2:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02035a4:	095000ef          	jal	ra,ffffffffc0203e38 <memset>
    tf.gpr.s0 = (uintptr_t)fn;       // s0 保存函数地址
ffffffffc02035a8:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;      // s1 保存函数参数
ffffffffc02035aa:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02035ac:	100027f3          	csrr	a5,sstatus
ffffffffc02035b0:	edd7f793          	andi	a5,a5,-291
ffffffffc02035b4:	1207e793          	ori	a5,a5,288
ffffffffc02035b8:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02035ba:	860a                	mv	a2,sp
ffffffffc02035bc:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02035c0:	00000797          	auipc	a5,0x0
ffffffffc02035c4:	c4078793          	addi	a5,a5,-960 # ffffffffc0203200 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02035c8:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02035ca:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02035cc:	d8dff0ef          	jal	ra,ffffffffc0203358 <do_fork>
}
ffffffffc02035d0:	70f2                	ld	ra,312(sp)
ffffffffc02035d2:	7452                	ld	s0,304(sp)
ffffffffc02035d4:	74b2                	ld	s1,296(sp)
ffffffffc02035d6:	7912                	ld	s2,288(sp)
ffffffffc02035d8:	6131                	addi	sp,sp,320
ffffffffc02035da:	8082                	ret

ffffffffc02035dc <do_exit>:
{
...
{
ffffffffc02035f2:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc02035f4:	e67fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc02035f8 <proc_init>:

// proc_init - 进程子系统初始化
// 系统启动时由 kern_init 调用。
void proc_init(void)
{
ffffffffc02035f8:	7179                	addi	sp,sp,-48
ffffffffc02035fa:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc02035fc:	0000a797          	auipc	a5,0xa
ffffffffc0203600:	e5c78793          	addi	a5,a5,-420 # ffffffffc020d458 <proc_list>
ffffffffc0203604:	f406                	sd	ra,40(sp)
ffffffffc0203606:	f022                	sd	s0,32(sp)
ffffffffc0203608:	e84a                	sd	s2,16(sp)
ffffffffc020360a:	e44e                	sd	s3,8(sp)
ffffffffc020360c:	00006497          	auipc	s1,0x6
ffffffffc0203610:	e3c48493          	addi	s1,s1,-452 # ffffffffc0209448 <hash_list>
ffffffffc0203614:	e79c                	sd	a5,8(a5)
ffffffffc0203616:	e39c                	sd	a5,0(a5)
    int i;

    // 初始化全局链表
    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i++)
ffffffffc0203618:	0000a717          	auipc	a4,0xa
ffffffffc020361c:	e3070713          	addi	a4,a4,-464 # ffffffffc020d448 <name.2>
ffffffffc0203620:	87a6                	mv	a5,s1
ffffffffc0203622:	e79c                	sd	a5,8(a5)
ffffffffc0203624:	e39c                	sd	a5,0(a5)
ffffffffc0203626:	07c1                	addi	a5,a5,16
ffffffffc0203628:	fef71de3          	bne	a4,a5,ffffffffc0203622 <proc_init+0x2a>
...
ffffffffc020362c:	bddff0ef          	jal	ra,ffffffffc0203208 <alloc_proc>
ffffffffc0203630:	0000a917          	auipc	s2,0xa
ffffffffc0203634:	ea890913          	addi	s2,s2,-344 # ffffffffc020d4d8 <idleproc>
ffffffffc0203638:	00a93023          	sd	a0,0(s2)
ffffffffc020363c:	18050d63          	beqz	a0,ffffffffc02037d6 <proc_init+0x1de>
    {
...
ffffffffc0203640:	07000513          	li	a0,112
ffffffffc0203644:	c6efe0ef          	jal	ra,ffffffffc0201ab2 <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0203648:	07000613          	li	a2,112
ffffffffc020364c:	4581                	li	a1,0
    int *context_mem = (int *)kmalloc(sizeof(struct context));
ffffffffc020364e:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0203650:	7e8000ef          	jal	ra,ffffffffc0203e38 <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc0203654:	00093503          	ld	a0,0(s2)
ffffffffc0203658:	85a2                	mv	a1,s0
ffffffffc020365a:	07000613          	li	a2,112
ffffffffc020365e:	03050513          	addi	a0,a0,48
ffffffffc0203662:	001000ef          	jal	ra,ffffffffc0203e62 <memcmp>
ffffffffc0203666:	89aa                	mv	s3,a0

    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc0203668:	453d                	li	a0,15
ffffffffc020366a:	c48fe0ef          	jal	ra,ffffffffc0201ab2 <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020366e:	463d                	li	a2,15
ffffffffc0203670:	4581                	li	a1,0
    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc0203672:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0203674:	7c4000ef          	jal	ra,ffffffffc0203e38 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0203678:	00093503          	ld	a0,0(s2)
ffffffffc020367c:	463d                	li	a2,15
ffffffffc020367e:	85a2                	mv	a1,s0
ffffffffc0203680:	0b450513          	addi	a0,a0,180
ffffffffc0203684:	7de000ef          	jal	ra,ffffffffc0203e62 <memcmp>
...
ffffffffc0203688:	00093783          	ld	a5,0(s2)
ffffffffc020368c:	0000a717          	auipc	a4,0xa
ffffffffc0203690:	e1473703          	ld	a4,-492(a4) # ffffffffc020d4a0 <boot_pgdir_pa>
ffffffffc0203694:	77d4                	ld	a3,168(a5)
ffffffffc0203696:	0ee68463          	beq	a3,a4,ffffffffc020377e <proc_init+0x186>
...
ffffffffc020369a:	4709                	li	a4,2
ffffffffc020369c:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack; // idle 使用启动时的 bootstack 作为内核栈
ffffffffc020369e:	00003717          	auipc	a4,0x3
ffffffffc02036a2:	96270713          	addi	a4,a4,-1694 # ffffffffc0206000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02036a6:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack; // idle 使用启动时的 bootstack 作为内核栈
ffffffffc02036aa:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;              // 标记需要调度，以便尽快切换到 init 进程
ffffffffc02036ac:	4705                	li	a4,1
ffffffffc02036ae:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02036b0:	4641                	li	a2,16
ffffffffc02036b2:	4581                	li	a1,0
ffffffffc02036b4:	8522                	mv	a0,s0
ffffffffc02036b6:	782000ef          	jal	ra,ffffffffc0203e38 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02036ba:	463d                	li	a2,15
ffffffffc02036bc:	00002597          	auipc	a1,0x2
ffffffffc02036c0:	fec58593          	addi	a1,a1,-20 # ffffffffc02056a8 <default_pmm_manager+0x9f0>
ffffffffc02036c4:	8522                	mv	a0,s0
ffffffffc02036c6:	784000ef          	jal	ra,ffffffffc0203e4a <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process++;
ffffffffc02036ca:	0000a717          	auipc	a4,0xa
ffffffffc02036ce:	e1e70713          	addi	a4,a4,-482 # ffffffffc020d4e8 <nr_process>
ffffffffc02036d2:	431c                	lw	a5,0(a4)
...
ffffffffc02036d8:	4601                	li	a2,0
    nr_process++;
ffffffffc02036da:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02036dc:	00002597          	auipc	a1,0x2
ffffffffc02036e0:	fd458593          	addi	a1,a1,-44 # ffffffffc02056b0 <default_pmm_manager+0x9f8>
ffffffffc02036e4:	00000517          	auipc	a0,0x0
ffffffffc02036e8:	b9450513          	addi	a0,a0,-1132 # ffffffffc0203278 <init_main>
    nr_process++;
ffffffffc02036ec:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc02036ee:	0000a797          	auipc	a5,0xa
ffffffffc02036f2:	ded7b123          	sd	a3,-542(a5) # ffffffffc020d4d0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02036f6:	e97ff0ef          	jal	ra,ffffffffc020358c <kernel_thread>
ffffffffc02036fa:	842a                	mv	s0,a0
    if (pid <= 0)
ffffffffc02036fc:	0ea05963          	blez	a0,ffffffffc02037ee <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID)
ffffffffc0203700:	6789                	lui	a5,0x2
ffffffffc0203702:	fff5071b          	addiw	a4,a0,-1
ffffffffc0203706:	17f9                	addi	a5,a5,-2
ffffffffc0203708:	2501                	sext.w	a0,a0
ffffffffc020370a:	02e7e363          	bltu	a5,a4,ffffffffc0203730 <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc020370e:	45a9                	li	a1,10
ffffffffc0203710:	282000ef          	jal	ra,ffffffffc0203992 <hash32>
ffffffffc0203714:	02051793          	slli	a5,a0,0x20
ffffffffc0203718:	01c7d693          	srli	a3,a5,0x1c
ffffffffc020371c:	96a6                	add	a3,a3,s1
ffffffffc020371e:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list)
ffffffffc0203720:	a029                	j	ffffffffc020372a <proc_init+0x132>
            if (proc->pid == pid)
ffffffffc0203722:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc0203726:	0a870563          	beq	a4,s0,ffffffffc02037d0 <proc_init+0x1d8>
    return listelm->next;
ffffffffc020372a:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc020372c:	fef69be3          	bne	a3,a5,ffffffffc0203722 <proc_init+0x12a>
    return NULL;
ffffffffc0203730:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203732:	0b478493          	addi	s1,a5,180
ffffffffc0203736:	4641                	li	a2,16
...
ffffffffc020373a:	0000a417          	auipc	s0,0xa
ffffffffc020373e:	da640413          	addi	s0,s0,-602 # ffffffffc020d4e0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203742:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0203744:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203746:	6f2000ef          	jal	ra,ffffffffc0203e38 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020374a:	463d                	li	a2,15
ffffffffc020374c:	00002597          	auipc	a1,0x2
ffffffffc0203750:	f9458593          	addi	a1,a1,-108 # ffffffffc02056e0 <default_pmm_manager+0xa28>
ffffffffc0203754:	8526                	mv	a0,s1
ffffffffc0203756:	6f4000ef          	jal	ra,ffffffffc0203e4a <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020375a:	00093783          	ld	a5,0(s2)
ffffffffc020375e:	c7e1                	beqz	a5,ffffffffc0203826 <proc_init+0x22e>
ffffffffc0203760:	43dc                	lw	a5,4(a5)
ffffffffc0203762:	e3f1                	bnez	a5,ffffffffc0203826 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0203764:	601c                	ld	a5,0(s0)
ffffffffc0203766:	c3c5                	beqz	a5,ffffffffc0203806 <proc_init+0x20e>
ffffffffc0203768:	43d8                	lw	a4,4(a5)
ffffffffc020376a:	4785                	li	a5,1
ffffffffc020376c:	08f71d63          	bne	a4,a5,ffffffffc0203806 <proc_init+0x20e>
}
...
ffffffffc0203780:	ff09                	bnez	a4,ffffffffc020369a <proc_init+0xa2>
ffffffffc0203782:	f0099ce3          	bnez	s3,ffffffffc020369a <proc_init+0xa2>
ffffffffc0203786:	6394                	ld	a3,0(a5)
ffffffffc0203788:	577d                	li	a4,-1
ffffffffc020378a:	1702                	slli	a4,a4,0x20
ffffffffc020378c:	f0e697e3          	bne	a3,a4,ffffffffc020369a <proc_init+0xa2>
ffffffffc0203790:	4798                	lw	a4,8(a5)
ffffffffc0203792:	f00714e3          	bnez	a4,ffffffffc020369a <proc_init+0xa2>
ffffffffc0203796:	6b98                	ld	a4,16(a5)
ffffffffc0203798:	f00711e3          	bnez	a4,ffffffffc020369a <proc_init+0xa2>
ffffffffc020379c:	4f98                	lw	a4,24(a5)
ffffffffc020379e:	2701                	sext.w	a4,a4
ffffffffc02037a0:	ee071de3          	bnez	a4,ffffffffc020369a <proc_init+0xa2>
ffffffffc02037a4:	7398                	ld	a4,32(a5)
ffffffffc02037a6:	ee071ae3          	bnez	a4,ffffffffc020369a <proc_init+0xa2>
ffffffffc02037aa:	7798                	ld	a4,40(a5)
ffffffffc02037ac:	ee0717e3          	bnez	a4,ffffffffc020369a <proc_init+0xa2>
ffffffffc02037b0:	0b07a703          	lw	a4,176(a5)
ffffffffc02037b4:	8d59                	or	a0,a0,a4
ffffffffc02037b6:	0005071b          	sext.w	a4,a0
ffffffffc02037ba:	ee0710e3          	bnez	a4,ffffffffc020369a <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc02037be:	00002517          	auipc	a0,0x2
ffffffffc02037c2:	ed250513          	addi	a0,a0,-302 # ffffffffc0205690 <default_pmm_manager+0x9d8>
ffffffffc02037c6:	9cffc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    idleproc->pid = 0;
ffffffffc02037ca:	00093783          	ld	a5,0(s2)
ffffffffc02037ce:	b5f1                	j	ffffffffc020369a <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02037d0:	f2878793          	addi	a5,a5,-216
ffffffffc02037d4:	bfb9                	j	ffffffffc0203732 <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
...
ffffffffc020384a:	e406                	sd	ra,8(sp)
ffffffffc020384c:	0000a417          	auipc	s0,0xa
ffffffffc0203850:	c8440413          	addi	s0,s0,-892 # ffffffffc020d4d0 <current>
    while (1)
    {
        if (current->need_resched)
ffffffffc0203854:	6018                	ld	a4,0(s0)
ffffffffc0203856:	4f1c                	lw	a5,24(a4)
...
ffffffffc02038e2:	e5a68693          	addi	a3,a3,-422 # ffffffffc0205738 <default_pmm_manager+0xa80>
ffffffffc02038e6:	00001617          	auipc	a2,0x1
ffffffffc02038ea:	02260613          	addi	a2,a2,34 # ffffffffc0204908 <commands+0x818>
ffffffffc02038ee:	45cd                	li	a1,19
ffffffffc02038f0:	00002517          	auipc	a0,0x2
ffffffffc02038f4:	e8850513          	addi	a0,a0,-376 # ffffffffc0205778 <default_pmm_manager+0xac0>
wakeup_proc(struct proc_struct *proc) {
ffffffffc02038f8:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02038fa:	b61fc0ef          	jal	ra,ffffffffc020045a <__panic>
...
ffffffffc0203902:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203904:	100027f3          	csrr	a5,sstatus
ffffffffc0203908:	8b89                	andi	a5,a5,2
ffffffffc020390a:	4401                	li	s0,0
ffffffffc020390c:	efbd                	bnez	a5,ffffffffc020398a <schedule+0x8c>
...
ffffffffc020390e:	0000a897          	auipc	a7,0xa
ffffffffc0203912:	bc28b883          	ld	a7,-1086(a7) # ffffffffc020d4d0 <current>
ffffffffc0203916:	0008ac23          	sw	zero,24(a7)
...
ffffffffc020391a:	0000a517          	auipc	a0,0xa
ffffffffc020391e:	bbe53503          	ld	a0,-1090(a0) # ffffffffc020d4d8 <idleproc>
ffffffffc0203922:	04a88e63          	beq	a7,a0,ffffffffc020397e <schedule+0x80>
ffffffffc0203926:	0c888693          	addi	a3,a7,200
ffffffffc020392a:	0000a617          	auipc	a2,0xa
ffffffffc020392e:	b2e60613          	addi	a2,a2,-1234 # ffffffffc020d458 <proc_list>
        le = last;
ffffffffc0203932:	87b6                	mv	a5,a3
...
ffffffffc0203936:	4809                	li	a6,2
ffffffffc0203938:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc020393a:	00c78863          	beq	a5,a2,ffffffffc020394a <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc020393e:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0203942:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0203946:	03070163          	beq	a4,a6,ffffffffc0203968 <schedule+0x6a>
                    break; // 找到就停止搜索
                }
            }
            // 如果遍历了一圈回到了起点 (le == last)，说明没有其他可运行进程
        } while (le != last);
ffffffffc020394a:	fef697e3          	bne	a3,a5,ffffffffc0203938 <schedule+0x3a>
        
        // 5. 处理 "无进程可运" 的情况
        // 如果遍历完链表没找到 RUNNABLE 进程，或者找到的进程实际上不可运行 (双重检查)
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc020394e:	ed89                	bnez	a1,ffffffffc0203968 <schedule+0x6a>
            next = idleproc;
        }
        ...
        next->runs ++;
ffffffffc0203950:	451c                	lw	a5,8(a0)
ffffffffc0203952:	2785                	addiw	a5,a5,1
ffffffffc0203954:	c51c                	sw	a5,8(a0)
        
        // 7. 执行进程切换
        // 只有当选中的 next 进程不是当前正在运行的 current 进程时，才需要切换。
        if (next != current) {
ffffffffc0203956:	00a88463          	beq	a7,a0,ffffffffc020395e <schedule+0x60>
            // proc_run 是上下文切换的核心函数 (在 proc.c 中定义)。
            // 它会保存 current 的寄存器，加载 next 的寄存器，并更新页表。
            // 这里的函数调用不会立即返回，直到 current 进程再次被调度回来。
            proc_run(next);
ffffffffc020395a:	991ff0ef          	jal	ra,ffffffffc02032ea <proc_run>
    if (flag) {
ffffffffc020395e:	e819                	bnez	s0,ffffffffc0203974 <schedule+0x76>
        }
    }
...
ffffffffc0203966:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0203968:	4198                	lw	a4,0(a1)
ffffffffc020396a:	4789                	li	a5,2
ffffffffc020396c:	fef712e3          	bne	a4,a5,ffffffffc0203950 <schedule+0x52>
ffffffffc0203970:	852e                	mv	a0,a1
ffffffffc0203972:	bff9                	j	ffffffffc0203950 <schedule+0x52>
ffffffffc0203974:	6402                	ld	s0,0(sp)
ffffffffc0203976:	60a2                	ld	ra,8(sp)
ffffffffc0203978:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc020397a:	fb1fc06f          	j	ffffffffc020092a <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
...
ffffffffc0203988:	b76d                	j	ffffffffc0203932 <schedule+0x34>
        intr_disable();
ffffffffc020398a:	fa7fc0ef          	jal	ra,ffffffffc0200930 <intr_disable>
        return 1;
ffffffffc020398e:	4405                	li	s0,1
ffffffffc0203990:	bfbd                	j	ffffffffc020390e <schedule+0x10>
...
ffffffffc0203996:	2785                	addiw	a5,a5,1
ffffffffc0203998:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc020399c:	02000793          	li	a5,32
ffffffffc02039a0:	9f8d                	subw	a5,a5,a1
}
ffffffffc02039a2:	00f5553b          	srlw	a0,a0,a5
...
ffffffffc02039a8:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02039ac:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc02039ae:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02039b2:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc02039b4:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02039b8:	f022                	sd	s0,32(sp)
ffffffffc02039ba:	ec26                	sd	s1,24(sp)
ffffffffc02039bc:	e84a                	sd	s2,16(sp)
ffffffffc02039be:	f406                	sd	ra,40(sp)
ffffffffc02039c0:	e44e                	sd	s3,8(sp)
ffffffffc02039c2:	84aa                	mv	s1,a0
ffffffffc02039c4:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc02039c6:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc02039ca:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc02039cc:	03067e63          	bgeu	a2,a6,ffffffffc0203a08 <printnum+0x60>
ffffffffc02039d0:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc02039d2:	00805763          	blez	s0,ffffffffc02039e0 <printnum+0x38>
ffffffffc02039d6:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc02039d8:	85ca                	mv	a1,s2
...
ffffffffc02039e0:	1a02                	slli	s4,s4,0x20
ffffffffc02039e2:	00002797          	auipc	a5,0x2
ffffffffc02039e6:	dae78793          	addi	a5,a5,-594 # ffffffffc0205790 <default_pmm_manager+0xad8>
ffffffffc02039ea:	020a5a13          	srli	s4,s4,0x20
ffffffffc02039ee:	9a3e                	add	s4,s4,a5
}
ffffffffc02039f0:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02039f2:	000a4503          	lbu	a0,0(s4)
}
ffffffffc02039f6:	70a2                	ld	ra,40(sp)
ffffffffc02039f8:	69a2                	ld	s3,8(sp)
ffffffffc02039fa:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02039fc:	85ca                	mv	a1,s2
ffffffffc02039fe:	87a6                	mv	a5,s1
}
ffffffffc0203a00:	6942                	ld	s2,16(sp)
ffffffffc0203a02:	64e2                	ld	s1,24(sp)
ffffffffc0203a04:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a06:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203a08:	03065633          	divu	a2,a2,a6
ffffffffc0203a0c:	8722                	mv	a4,s0
ffffffffc0203a0e:	f9bff0ef          	jal	ra,ffffffffc02039a8 <printnum>
ffffffffc0203a12:	b7f9                	j	ffffffffc02039e0 <printnum+0x38>

ffffffffc0203a14 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203a14:	7119                	addi	sp,sp,-128
...
ffffffffc0203a24:	f06a                	sd	s10,32(sp)
ffffffffc0203a26:	fc86                	sd	ra,120(sp)
ffffffffc0203a28:	f8a2                	sd	s0,112(sp)
ffffffffc0203a2a:	f862                	sd	s8,48(sp)
ffffffffc0203a2c:	f466                	sd	s9,40(sp)
ffffffffc0203a2e:	ec6e                	sd	s11,24(sp)
ffffffffc0203a30:	892a                	mv	s2,a0
ffffffffc0203a32:	84ae                	mv	s1,a1
ffffffffc0203a34:	8d32                	mv	s10,a2
ffffffffc0203a36:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203a38:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203a3c:	5b7d                	li	s6,-1
ffffffffc0203a3e:	00002a97          	auipc	s5,0x2
ffffffffc0203a42:	d7ea8a93          	addi	s5,s5,-642 # ffffffffc02057bc <default_pmm_manager+0xb04>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203a46:	00002b97          	auipc	s7,0x2
ffffffffc0203a4a:	f52b8b93          	addi	s7,s7,-174 # ffffffffc0205998 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203a4e:	000d4503          	lbu	a0,0(s10)
ffffffffc0203a52:	001d0413          	addi	s0,s10,1
ffffffffc0203a56:	01350a63          	beq	a0,s3,ffffffffc0203a6a <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203a5a:	c121                	beqz	a0,ffffffffc0203a9a <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203a5c:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203a5e:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203a60:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203a62:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203a66:	ff351ae3          	bne	a0,s3,ffffffffc0203a5a <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203a6a:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203a6e:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203a72:	4c81                	li	s9,0
ffffffffc0203a74:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203a76:	5c7d                	li	s8,-1
ffffffffc0203a78:	5dfd                	li	s11,-1
ffffffffc0203a7a:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203a7e:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203a80:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203a84:	0ff5f593          	zext.b	a1,a1
ffffffffc0203a88:	00140d13          	addi	s10,s0,1
ffffffffc0203a8c:	04b56263          	bltu	a0,a1,ffffffffc0203ad0 <vprintfmt+0xbc>
ffffffffc0203a90:	058a                	slli	a1,a1,0x2
ffffffffc0203a92:	95d6                	add	a1,a1,s5
ffffffffc0203a94:	4194                	lw	a3,0(a1)
ffffffffc0203a96:	96d6                	add	a3,a3,s5
ffffffffc0203a98:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203ab6:	8082                	ret
            padc = '0';
ffffffffc0203ab8:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203aba:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203abe:	846a                	mv	s0,s10
ffffffffc0203ac0:	00140d13          	addi	s10,s0,1
ffffffffc0203ac4:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203ac8:	0ff5f593          	zext.b	a1,a1
ffffffffc0203acc:	fcb572e3          	bgeu	a0,a1,ffffffffc0203a90 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203ad0:	85a6                	mv	a1,s1
ffffffffc0203ad2:	02500513          	li	a0,37
ffffffffc0203ad6:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203ad8:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203adc:	8d22                	mv	s10,s0
ffffffffc0203ade:	f73788e3          	beq	a5,s3,ffffffffc0203a4e <vprintfmt+0x3a>
ffffffffc0203ae2:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203ae6:	1d7d                	addi	s10,s10,-1
ffffffffc0203ae8:	ff379de3          	bne	a5,s3,ffffffffc0203ae2 <vprintfmt+0xce>
ffffffffc0203aec:	b78d                	j	ffffffffc0203a4e <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203aee:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0203af2:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203af6:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203af8:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203afc:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203b00:	02d86463          	bltu	a6,a3,ffffffffc0203b28 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203b04:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203b08:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203b0c:	0186873b          	addw	a4,a3,s8
ffffffffc0203b10:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203b14:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0203b16:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0203b1a:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0203b1c:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0203b20:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203b24:	fed870e3          	bgeu	a6,a3,ffffffffc0203b04 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0203b28:	f40ddce3          	bgez	s11,ffffffffc0203a80 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0203b2c:	8de2                	mv	s11,s8
ffffffffc0203b2e:	5c7d                	li	s8,-1
ffffffffc0203b30:	bf81                	j	ffffffffc0203a80 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0203b32:	fffdc693          	not	a3,s11
ffffffffc0203b36:	96fd                	srai	a3,a3,0x3f
ffffffffc0203b38:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b3c:	00144603          	lbu	a2,1(s0)
ffffffffc0203b40:	2d81                	sext.w	s11,s11
ffffffffc0203b42:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203b44:	bf35                	j	ffffffffc0203a80 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0203b46:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc0203b52:	bfd9                	j	ffffffffc0203b28 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0203b54:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203b56:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203b5a:	01174463          	blt	a4,a7,ffffffffc0203b62 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0203b5e:	1a088e63          	beqz	a7,ffffffffc0203d1a <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0203b62:	000a3603          	ld	a2,0(s4)
ffffffffc0203b66:	46c1                	li	a3,16
ffffffffc0203b68:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0203b6a:	2781                	sext.w	a5,a5
ffffffffc0203b6c:	876e                	mv	a4,s11
ffffffffc0203b6e:	85a6                	mv	a1,s1
ffffffffc0203b70:	854a                	mv	a0,s2
ffffffffc0203b72:	e37ff0ef          	jal	ra,ffffffffc02039a8 <printnum>
            break;
ffffffffc0203b76:	bde1                	j	ffffffffc0203a4e <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0203b78:	000a2503          	lw	a0,0(s4)
ffffffffc0203b7c:	85a6                	mv	a1,s1
ffffffffc0203b7e:	0a21                	addi	s4,s4,8
ffffffffc0203b80:	9902                	jalr	s2
            break;
ffffffffc0203b82:	b5f1                	j	ffffffffc0203a4e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203b84:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203b86:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203b8a:	01174463          	blt	a4,a7,ffffffffc0203b92 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0203b8e:	18088163          	beqz	a7,ffffffffc0203d10 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0203b92:	000a3603          	ld	a2,0(s4)
ffffffffc0203b96:	46a9                	li	a3,10
ffffffffc0203b98:	8a2e                	mv	s4,a1
ffffffffc0203b9a:	bfc1                	j	ffffffffc0203b6a <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b9c:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0203ba0:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ba2:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203ba4:	bdf1                	j	ffffffffc0203a80 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0203ba6:	85a6                	mv	a1,s1
ffffffffc0203ba8:	02500513          	li	a0,37
ffffffffc0203bac:	9902                	jalr	s2
            break;
ffffffffc0203bae:	b545                	j	ffffffffc0203a4e <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bb0:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0203bb4:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bb6:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203bb8:	b5e1                	j	ffffffffc0203a80 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0203bba:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203bbc:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203bc0:	01174463          	blt	a4,a7,ffffffffc0203bc8 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0203bc4:	14088163          	beqz	a7,ffffffffc0203d06 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0203bc8:	000a3603          	ld	a2,0(s4)
ffffffffc0203bcc:	46a1                	li	a3,8
ffffffffc0203bce:	8a2e                	mv	s4,a1
ffffffffc0203bd0:	bf69                	j	ffffffffc0203b6a <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0203bd2:	03000513          	li	a0,48
ffffffffc0203bd6:	85a6                	mv	a1,s1
ffffffffc0203bd8:	e03e                	sd	a5,0(sp)
ffffffffc0203bda:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0203bdc:	85a6                	mv	a1,s1
ffffffffc0203bde:	07800513          	li	a0,120
ffffffffc0203be2:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203be4:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0203be6:	6782                	ld	a5,0(sp)
ffffffffc0203be8:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203bea:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0203bee:	bfb5                	j	ffffffffc0203b6a <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203bf0:	000a3403          	ld	s0,0(s4)
ffffffffc0203bf4:	008a0713          	addi	a4,s4,8
ffffffffc0203bf8:	e03a                	sd	a4,0(sp)
ffffffffc0203bfa:	14040263          	beqz	s0,ffffffffc0203d3e <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0203bfe:	0fb05763          	blez	s11,ffffffffc0203cec <vprintfmt+0x2d8>
ffffffffc0203c02:	02d00693          	li	a3,45
ffffffffc0203c06:	0cd79163          	bne	a5,a3,ffffffffc0203cc8 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c0a:	00044783          	lbu	a5,0(s0)
ffffffffc0203c0e:	0007851b          	sext.w	a0,a5
ffffffffc0203c12:	cf85                	beqz	a5,ffffffffc0203c4a <vprintfmt+0x236>
ffffffffc0203c14:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203c18:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c1c:	000c4563          	bltz	s8,ffffffffc0203c26 <vprintfmt+0x212>
ffffffffc0203c20:	3c7d                	addiw	s8,s8,-1
ffffffffc0203c22:	036c0263          	beq	s8,s6,ffffffffc0203c46 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0203c26:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203c28:	0e0c8e63          	beqz	s9,ffffffffc0203d24 <vprintfmt+0x310>
ffffffffc0203c2c:	3781                	addiw	a5,a5,-32
ffffffffc0203c2e:	0ef47b63          	bgeu	s0,a5,ffffffffc0203d24 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0203c32:	03f00513          	li	a0,63
ffffffffc0203c36:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c38:	000a4783          	lbu	a5,0(s4)
ffffffffc0203c3c:	3dfd                	addiw	s11,s11,-1
ffffffffc0203c3e:	0a05                	addi	s4,s4,1
ffffffffc0203c40:	0007851b          	sext.w	a0,a5
ffffffffc0203c44:	ffe1                	bnez	a5,ffffffffc0203c1c <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0203c46:	01b05963          	blez	s11,ffffffffc0203c58 <vprintfmt+0x244>
ffffffffc0203c4a:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203c4c:	85a6                	mv	a1,s1
ffffffffc0203c4e:	02000513          	li	a0,32
ffffffffc0203c52:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203c54:	fe0d9be3          	bnez	s11,ffffffffc0203c4a <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203c58:	6a02                	ld	s4,0(sp)
ffffffffc0203c5a:	bbd5                	j	ffffffffc0203a4e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203c5c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203c5e:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0203c62:	01174463          	blt	a4,a7,ffffffffc0203c6a <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0203c66:	08088d63          	beqz	a7,ffffffffc0203d00 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0203c6a:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0203c6e:	0a044d63          	bltz	s0,ffffffffc0203d28 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0203c72:	8622                	mv	a2,s0
ffffffffc0203c74:	8a66                	mv	s4,s9
ffffffffc0203c76:	46a9                	li	a3,10
ffffffffc0203c78:	bdcd                	j	ffffffffc0203b6a <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0203c7a:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203c7e:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0203c80:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0203c82:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0203c86:	8fb5                	xor	a5,a5,a3
ffffffffc0203c88:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203c8c:	02d74163          	blt	a4,a3,ffffffffc0203cae <vprintfmt+0x29a>
ffffffffc0203c90:	00369793          	slli	a5,a3,0x3
ffffffffc0203c94:	97de                	add	a5,a5,s7
ffffffffc0203c96:	639c                	ld	a5,0(a5)
ffffffffc0203c98:	cb99                	beqz	a5,ffffffffc0203cae <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0203c9a:	86be                	mv	a3,a5
ffffffffc0203c9c:	00000617          	auipc	a2,0x0
ffffffffc0203ca0:	21460613          	addi	a2,a2,532 # ffffffffc0203eb0 <etext+0x2a>
ffffffffc0203ca4:	85a6                	mv	a1,s1
ffffffffc0203ca6:	854a                	mv	a0,s2
ffffffffc0203ca8:	0ce000ef          	jal	ra,ffffffffc0203d76 <printfmt>
ffffffffc0203cac:	b34d                	j	ffffffffc0203a4e <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0203cae:	00002617          	auipc	a2,0x2
ffffffffc0203cb2:	b0260613          	addi	a2,a2,-1278 # ffffffffc02057b0 <default_pmm_manager+0xaf8>
ffffffffc0203cb6:	85a6                	mv	a1,s1
ffffffffc0203cb8:	854a                	mv	a0,s2
ffffffffc0203cba:	0bc000ef          	jal	ra,ffffffffc0203d76 <printfmt>
ffffffffc0203cbe:	bb41                	j	ffffffffc0203a4e <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0203cc0:	00002417          	auipc	s0,0x2
ffffffffc0203cc4:	ae840413          	addi	s0,s0,-1304 # ffffffffc02057a8 <default_pmm_manager+0xaf0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203cc8:	85e2                	mv	a1,s8
ffffffffc0203cca:	8522                	mv	a0,s0
ffffffffc0203ccc:	e43e                	sd	a5,8(sp)
ffffffffc0203cce:	0e2000ef          	jal	ra,ffffffffc0203db0 <strnlen>
ffffffffc0203cd2:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0203cd6:	01b05b63          	blez	s11,ffffffffc0203cec <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0203cda:	67a2                	ld	a5,8(sp)
ffffffffc0203cdc:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203ce0:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0203ce2:	85a6                	mv	a1,s1
ffffffffc0203ce4:	8552                	mv	a0,s4
ffffffffc0203ce6:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203ce8:	fe0d9ce3          	bnez	s11,ffffffffc0203ce0 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203cec:	00044783          	lbu	a5,0(s0)
ffffffffc0203cf0:	00140a13          	addi	s4,s0,1
ffffffffc0203cf4:	0007851b          	sext.w	a0,a5
ffffffffc0203cf8:	d3a5                	beqz	a5,ffffffffc0203c58 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203cfa:	05e00413          	li	s0,94
ffffffffc0203cfe:	bf39                	j	ffffffffc0203c1c <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0203d00:	000a2403          	lw	s0,0(s4)
ffffffffc0203d04:	b7ad                	j	ffffffffc0203c6e <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0203d06:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d0a:	46a1                	li	a3,8
ffffffffc0203d0c:	8a2e                	mv	s4,a1
ffffffffc0203d0e:	bdb1                	j	ffffffffc0203b6a <vprintfmt+0x156>
ffffffffc0203d10:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d14:	46a9                	li	a3,10
ffffffffc0203d16:	8a2e                	mv	s4,a1
ffffffffc0203d18:	bd89                	j	ffffffffc0203b6a <vprintfmt+0x156>
ffffffffc0203d1a:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d1e:	46c1                	li	a3,16
ffffffffc0203d20:	8a2e                	mv	s4,a1
ffffffffc0203d22:	b5a1                	j	ffffffffc0203b6a <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0203d24:	9902                	jalr	s2
ffffffffc0203d26:	bf09                	j	ffffffffc0203c38 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0203d28:	85a6                	mv	a1,s1
ffffffffc0203d2a:	02d00513          	li	a0,45
ffffffffc0203d2e:	e03e                	sd	a5,0(sp)
ffffffffc0203d30:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0203d32:	6782                	ld	a5,0(sp)
ffffffffc0203d34:	8a66                	mv	s4,s9
ffffffffc0203d36:	40800633          	neg	a2,s0
ffffffffc0203d3a:	46a9                	li	a3,10
ffffffffc0203d3c:	b53d                	j	ffffffffc0203b6a <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0203d3e:	03b05163          	blez	s11,ffffffffc0203d60 <vprintfmt+0x34c>
ffffffffc0203d42:	02d00693          	li	a3,45
ffffffffc0203d46:	f6d79de3          	bne	a5,a3,ffffffffc0203cc0 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0203d4a:	00002417          	auipc	s0,0x2
ffffffffc0203d4e:	a5e40413          	addi	s0,s0,-1442 # ffffffffc02057a8 <default_pmm_manager+0xaf0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203d52:	02800793          	li	a5,40
ffffffffc0203d56:	02800513          	li	a0,40
ffffffffc0203d5a:	00140a13          	addi	s4,s0,1
ffffffffc0203d5e:	bd6d                	j	ffffffffc0203c18 <vprintfmt+0x204>
ffffffffc0203d60:	00002a17          	auipc	s4,0x2
ffffffffc0203d64:	a49a0a13          	addi	s4,s4,-1463 # ffffffffc02057a9 <default_pmm_manager+0xaf1>
ffffffffc0203d68:	02800513          	li	a0,40
ffffffffc0203d6c:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203d70:	05e00413          	li	s0,94
ffffffffc0203d74:	b565                	j	ffffffffc0203c1c <vprintfmt+0x208>

ffffffffc0203d76 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203d76:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0203d78:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203d7c:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203d7e:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203d80:	ec06                	sd	ra,24(sp)
ffffffffc0203d82:	f83a                	sd	a4,48(sp)
ffffffffc0203d84:	fc3e                	sd	a5,56(sp)
ffffffffc0203d86:	e0c2                	sd	a6,64(sp)
ffffffffc0203d88:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0203d8a:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203d8c:	c89ff0ef          	jal	ra,ffffffffc0203a14 <vprintfmt>
}
ffffffffc0203d90:	60e2                	ld	ra,24(sp)
ffffffffc0203d92:	6161                	addi	sp,sp,80
ffffffffc0203d94:	8082                	ret

ffffffffc0203d96 <strlen>:
...
strlen(const char *s) {
ffffffffc0203d9a:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0203d9c:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0203d9e:	cb81                	beqz	a5,ffffffffc0203dae <strlen+0x18>
        cnt ++;
ffffffffc0203da0:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0203da2:	00a707b3          	add	a5,a4,a0
ffffffffc0203da6:	0007c783          	lbu	a5,0(a5)
ffffffffc0203daa:	fbfd                	bnez	a5,ffffffffc0203da0 <strlen+0xa>
...
ffffffffc0203db0:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203db2:	e589                	bnez	a1,ffffffffc0203dbc <strnlen+0xc>
ffffffffc0203db4:	a811                	j	ffffffffc0203dc8 <strnlen+0x18>
        cnt ++;
ffffffffc0203db6:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203db8:	00f58863          	beq	a1,a5,ffffffffc0203dc8 <strnlen+0x18>
ffffffffc0203dbc:	00f50733          	add	a4,a0,a5
ffffffffc0203dc0:	00074703          	lbu	a4,0(a4)
ffffffffc0203dc4:	fb6d                	bnez	a4,ffffffffc0203db6 <strnlen+0x6>
ffffffffc0203dc6:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0203dc8:	852e                	mv	a0,a1
ffffffffc0203dca:	8082                	ret

ffffffffc0203dcc <strcpy>:
char *
...
ffffffffc0203dd6:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0203dda:	fb75                	bnez	a4,ffffffffc0203dce <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0203de2:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203de6:	cb89                	beqz	a5,ffffffffc0203df8 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0203de8:	0505                	addi	a0,a0,1
ffffffffc0203dea:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203dec:	fee789e3          	beq	a5,a4,ffffffffc0203dde <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203df0:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0203df4:	9d19                	subw	a0,a0,a4
ffffffffc0203df6:	8082                	ret
ffffffffc0203df8:	4501                	li	a0,0
ffffffffc0203dfa:	bfed                	j	ffffffffc0203df4 <strcmp+0x16>

ffffffffc0203dfc <strncmp>:
...
ffffffffc0203dfc:	c20d                	beqz	a2,ffffffffc0203e1e <strncmp+0x22>
ffffffffc0203dfe:	962e                	add	a2,a2,a1
ffffffffc0203e00:	a031                	j	ffffffffc0203e0c <strncmp+0x10>
        n --, s1 ++, s2 ++;
ffffffffc0203e02:	0505                	addi	a0,a0,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203e04:	00e79a63          	bne	a5,a4,ffffffffc0203e18 <strncmp+0x1c>
ffffffffc0203e08:	00b60b63          	beq	a2,a1,ffffffffc0203e1e <strncmp+0x22>
ffffffffc0203e0c:	00054783          	lbu	a5,0(a0)
        n --, s1 ++, s2 ++;
ffffffffc0203e10:	0585                	addi	a1,a1,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203e12:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0203e16:	f7f5                	bnez	a5,ffffffffc0203e02 <strncmp+0x6>
    }
    return (n == 0) ? 0 : (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203e18:	40e7853b          	subw	a0,a5,a4
}
...
ffffffffc0203e26:	c799                	beqz	a5,ffffffffc0203e34 <strchr+0x12>
        if (*s == c) {
ffffffffc0203e28:	00f58763          	beq	a1,a5,ffffffffc0203e36 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0203e2c:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0203e30:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0203e32:	fbfd                	bnez	a5,ffffffffc0203e28 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0203e38:	ca01                	beqz	a2,ffffffffc0203e48 <memset+0x10>
ffffffffc0203e3a:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0203e3c:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0203e3e:	0785                	addi	a5,a5,1
ffffffffc0203e40:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0203e44:	fec79de3          	bne	a5,a2,ffffffffc0203e3e <memset+0x6>
    }
    return s;
...
ffffffffc0203e4a <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0203e4a:	ca19                	beqz	a2,ffffffffc0203e60 <memcpy+0x16>
ffffffffc0203e4c:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0203e4e:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0203e50:	0005c703          	lbu	a4,0(a1)
ffffffffc0203e54:	0585                	addi	a1,a1,1
ffffffffc0203e56:	0785                	addi	a5,a5,1
ffffffffc0203e58:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0203e5c:	fec59ae3          	bne	a1,a2,ffffffffc0203e50 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0203e62:	c205                	beqz	a2,ffffffffc0203e82 <memcmp+0x20>
ffffffffc0203e64:	962e                	add	a2,a2,a1
ffffffffc0203e66:	a019                	j	ffffffffc0203e6c <memcmp+0xa>
ffffffffc0203e68:	00c58d63          	beq	a1,a2,ffffffffc0203e82 <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0203e6c:	00054783          	lbu	a5,0(a0)
ffffffffc0203e70:	0005c703          	lbu	a4,0(a1)
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0203e74:	0505                	addi	a0,a0,1
ffffffffc0203e76:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0203e78:	fee788e3          	beq	a5,a4,ffffffffc0203e68 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203e7c:	40e7853b          	subw	a0,a5,a4
ffffffffc0203e80:	8082                	ret
    }
    return 0;
ffffffffc0203e82:	4501                	li	a0,0
}
