...
obj/__user_cow_data.out:     file format elf64-littleriscv
...
exit(int error_code) {
  ...
  8000d4:	4d050513          	addi	a0,a0,1232 # 8005a0 <main+0xa8>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80012c:	49078793          	addi	a5,a5,1168 # 8005b8 <main+0xc0>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800188:	468a8a93          	addi	s5,s5,1128 # 8005ec <main+0xf4>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800190:	67cb8b93          	addi	s7,s7,1660 # 800808 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003e6:	20660613          	addi	a2,a2,518 # 8005e8 <main+0xf0>
  ...
  8003f8:	1e460613          	addi	a2,a2,484 # 8005d8 <main+0xe0>
  ...
  80040a:	1ca40413          	addi	s0,s0,458 # 8005d0 <main+0xd8>
  ...
  800494:	14040413          	addi	s0,s0,320 # 8005d0 <main+0xd8>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004aa:	12ba0a13          	addi	s4,s4,299 # 8005d1 <main+0xd9>
...
int main(void) {
  ...
  8004fe:	3d650513          	addi	a0,a0,982 # 8008d0 <error_string+0xc8>
int main(void) {
  ...
  80050c:	bd3ff0ef          	jal	ra,8000de <fork>
    ...
    if (pid == 0) {
  800510:	e121                	bnez	a0,800550 <main+0x58>
        // 子进程
        cprintf("Child: Writing to global_flag...\n");
  800512:	00000517          	auipc	a0,0x0
  800516:	3de50513          	addi	a0,a0,990 # 8008f0 <error_string+0xe8>
  80051a:	b27ff0ef          	jal	ra,800040 <cprintf>
        // 这一步写入操作应该触发 Page Fault -> Copy on Write
        global_flag = 1; 
  80051e:	00001497          	auipc	s1,0x1
  800522:	ae248493          	addi	s1,s1,-1310 # 801000 <global_flag>
  800526:	4405                	li	s0,1
        cprintf("Child: global_flag = %d (Should be 1)\n", global_flag);
  800528:	4585                	li	a1,1
  80052a:	00000517          	auipc	a0,0x0
  80052e:	3ee50513          	addi	a0,a0,1006 # 800918 <error_string+0x110>
        global_flag = 1; 
  800532:	c080                	sw	s0,0(s1)
        cprintf("Child: global_flag = %d (Should be 1)\n", global_flag);
  800534:	b0dff0ef          	jal	ra,800040 <cprintf>
        if (global_flag != 1) {
  800538:	409c                	lw	a5,0(s1)
  80053a:	04878e63          	beq	a5,s0,800596 <main+0x9e>
             cprintf("Child: ERROR - Write failed\n");
  80053e:	00000517          	auipc	a0,0x0
  800542:	40250513          	addi	a0,a0,1026 # 800940 <error_string+0x138>
  800546:	afbff0ef          	jal	ra,800040 <cprintf>
             exit(-1);
  80054a:	557d                	li	a0,-1
  80054c:	b7dff0ef          	jal	ra,8000c8 <exit>
        }
        exit(0);
    } else {
        // 父进程
  ...
  800550:	4581                	li	a1,0
  800552:	b8fff0ef          	jal	ra,8000e0 <waitpid>
        
        cprintf("Parent: global_flag = %d (Should be 0)\n", global_flag);
  800556:	00001417          	auipc	s0,0x1
  80055a:	aaa40413          	addi	s0,s0,-1366 # 801000 <global_flag>
  80055e:	400c                	lw	a1,0(s0)
  800560:	00000517          	auipc	a0,0x0
  800564:	40050513          	addi	a0,a0,1024 # 800960 <error_string+0x158>
  800568:	ad9ff0ef          	jal	ra,800040 <cprintf>
        
        if (global_flag == 0) {
  80056c:	401c                	lw	a5,0(s0)
  80056e:	cf89                	beqz	a5,800588 <main+0x90>
            cprintf("COW Data Isolation Test: PASSED\n");
        } else {
            cprintf("COW Data Isolation Test: FAILED (Data corrupted)\n");
  800570:	00000517          	auipc	a0,0x0
  800574:	44050513          	addi	a0,a0,1088 # 8009b0 <error_string+0x1a8>
  800578:	ac9ff0ef          	jal	ra,800040 <cprintf>
        }
    }
    return 0;
  80057c:	60e2                	ld	ra,24(sp)
  80057e:	6442                	ld	s0,16(sp)
  800580:	64a2                	ld	s1,8(sp)
  800582:	4501                	li	a0,0
  800584:	6105                	addi	sp,sp,32
  800586:	8082                	ret
            cprintf("COW Data Isolation Test: PASSED\n");
  800588:	00000517          	auipc	a0,0x0
  80058c:	40050513          	addi	a0,a0,1024 # 800988 <error_string+0x180>
  800590:	ab1ff0ef          	jal	ra,800040 <cprintf>
  800594:	b7e5                	j	80057c <main+0x84>
        exit(0);
  800596:	4501                	li	a0,0
  800598:	b31ff0ef          	jal	ra,8000c8 <exit>
